...
DIST          = /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		include/ImGuizmo.h src/main.cpp \
		src/Scene.cpp \
		src/Particle.cpp \
		src/FireworkParticle.cpp \
		src/FlameParticle.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Scene.h include/Particle.h include/FireworkParticle.h include/FlameParticle.h include/Emitter.h include/pngutils.h imgui/include/imgui.h imgui/include/stb_rect_pack.h imgui/include/stb_truetype.h imgui/include/imconfig.h imgui/include/imgui_internal.h imgui/include/stb_textedit.h imgui/include/ImGUIImpl.h include/ExplosionParticle.h include/ImGuizmo.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/Scene.cpp src/Particle.cpp src/FireworkParticle.cpp src/FlameParticle.cpp src/Emitter.cpp src/pngutils.cpp imgui/src/imgui.cpp imgui/src/imgui_draw.cpp imgui/src/ImGUIImpl.cpp src/ExplosionParticle.cpp imgui/src/colourpick.cpp src/ImGuizmo.cpp $(DISTDIR)/
...
ImGuizmo.o: src/ImGuizmo.cpp imgui/include/imgui.h \
		imgui/include/imconfig.h \
		imgui/include/imgui_internal.h \
		imgui/include/stb_textedit.h \
		include/ImGuizmo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ImGuizmo.o src/ImGuizmo.cpp
